...
export class StatusBar {
    ...
    public readonly mainSelector = 'div[id="workbench.parts.statusbar"]';
    ...
    public async waitForStatusbarLinkText(title: string, text?: string): Promise<string> {
        return this.code.waitForTextContent(`${this.mainSelector} a[title="${title}"]`, text);
    }
