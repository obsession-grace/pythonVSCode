...
Then('there {word} {int} {word} in the problems panel', async (_isOare: 'is' | 'are', count: number, category: 'error' | 'warning' | 'errors' | 'warnings') => {
    await checkProblems(count, category);
});
