...
export async function createPipEnv(environment: PipEnvEnviroment, app: Application): Promise<string> {
    ...
    const runPyFileArg = `"python ${toCommandArgument('/Users/donjayamanne/Desktop/Development/PythonStuff/smoke tests/env 0-virtualenv/runInTerminal.py').replace(/\"/g, '\\"')}"`;
