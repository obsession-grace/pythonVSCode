...
import { openDocument } from '../common';
...
suite('Hover Definition', () => {
    ...
    test('Method', done => {
        openDocument(fileOne).then(textDocument => {
    ...
    test('Across files', done => {
        openDocument(fileThree).then(textDocument => {
    ...
    test('With Unicode Characters', done => {
        openDocument(fileEncoding).then(textDocument => {
    ...
    test('Across files with Unicode Characters', done => {
        openDocument(fileEncodingUsed).then(textDocument => {
    ...
    test('Nothing for keywords (for)', done => {
        openDocument(fileHover).then(textDocument => {
    ...
    test('format().capitalize()', async () => {
        const textDocument = await openDocument(fileStringFormat);
